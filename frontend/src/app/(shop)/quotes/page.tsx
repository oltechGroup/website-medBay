        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 md:gap-8 mb-8 md:mb-12">
          <div>
            <div className="flex items-center gap-3 mb-2">
               ...
               <span className="text-[10px] md:text-xs font-bold text-blue-600 uppercase tracking-widest">Procurement Management</span>
            </div>
            <h1 className="text-3xl md:text-4xl font-black text-slate-900 tracking-tight leading-tight">My Quotes</h1>
            <p className="text-slate-500 mt-2 font-medium text-base md:text-lg max-w-xl">
              Manage your special product requests and review commercial proposals.
            </p>
          </div>
          ...
          >
            ...
            <span className="text-sm md:text-base">Search New Product</span>
          </Link>
        </div>
        ...
        <div className="space-y-4 md:space-y-6">
          {isLoading ? (
            ...
            <div className="bg-white rounded-2xl md:rounded-[3rem] p-10 md:p-16 text-center border border-dashed border-slate-200 flex flex-col items-center">
              ...
              <h3 className="text-xl md:text-2xl font-black text-slate-900 mb-2 md:mb-3">You have no quotes</h3>
              <p className="text-slate-500 max-w-md mx-auto mb-6 md:mb-8 font-medium text-sm md:text-base">
                Looking for a specific product or a large batch? Request a quote directly from our catalog.
              </p>
              <Link 
                href="/products" 
              ...
              >
                Go to Catalog <ChevronRight size={18} className="md:w-5 md:h-5" />
              </Link>
            </div>
          ) : (
                  ...
                  <div className="p-5 md:p-8 flex flex-col md:flex-row gap-6 md:gap-8 items-start md:items-center justify-between">
                    ...
                    <div className="w-full md:w-auto flex flex-col items-end gap-2 md:gap-3 min-w-[180px]">
                      {status.actionRequired ? (
                        ...
                        >
                          View Details <ChevronRight size={16} className="md:w-[18px] md:h-[18px]" />
                        </button>
                      )}

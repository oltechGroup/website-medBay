        ...
        <div className="mb-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center space-x-4 mb-4 sm:mb-0">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">Catálogo - Productos Caducados</h1>
                <p className="text-gray-600">
                  Productos vencidos del proveedor
                </p>
              </div>
            </div>
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 mb-6">
              {searchTerm 
                ...
                : 'Los productos caducados aparecerán aquí una vez que sean importados'
              }
            </p>
            <button
              onClick={() => {

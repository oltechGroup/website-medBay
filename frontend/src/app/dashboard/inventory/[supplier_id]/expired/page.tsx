...
import { ArrowLeft, Package, Search, Filter, Download, DollarSign, Box, BarChart3, AlertTriangle } from 'lucide-react';
...
export default function ExpiredCatalogPage() {
  ...
  const loadProducts = async () => {
    try {
      const productsData = await getCatalogBySupplierAndCategory(params.supplier_id as string, 'expired');
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center space-x-4 mb-4 sm:mb-0">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">Catálogo - Lotes Caducados</h1>
                <p className="text-gray-600">
                  Lotes vencidos del proveedor - Disponibles para venta
                </p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          {/* 📦 TOTAL DE LOTES CADUCADOS */}
          <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">Lotes Caducados</p>
                <p className="text-2xl font-bold text-gray-900">{products.length}</p>
                <p className="text-xs text-gray-500 mt-1">Lotes vencidos</p>
              </div>
              <div className="p-3 bg-red-100 rounded-lg">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">Unidades Caducadas</p>
                <p className="text-2xl font-bold text-gray-900">
                  {totalUnits.toLocaleString('es-MX')}
                </p>
                <p className="text-xs text-gray-500 mt-1">Stock vencido</p>
              </div>
              <div className="p-3 bg-red-100 rounded-lg">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">Valor de lotes vencidos</p>
              </div>
              <div className="p-3 bg-red-100 rounded-lg">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div className="flex space-x-4">
              <select
                ...
                className="border border-gray-300 rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all"
              >
                <option value="expiry">Ordenar por fecha de caducidad</option>
            ...
            {filteredProducts.length > 0 ? (
              ...
              <div className="text-center py-16 bg-white border border-gray-200 rounded-lg hover:shadow-md transition-shadow">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-3">
                  {searchTerm ? 'No se encontraron lotes' : 'No hay lotes caducados'}
                </h3>
                <p className="text-gray-600 max-w-md mx-auto mb-8 leading-relaxed">
                  {searchTerm 
                    ? 'No se encontraron lotes que coincidan con tu búsqueda. Intenta con otros términos.'
                    : 'Los lotes caducados aparecerán aquí. Estos productos están disponibles para venta.'
                  }
                </p>
                <div className="flex justify-center space-x-4">
                  {searchTerm && (
                    <button
                      onClick={() => setSearchTerm('')}
                      className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-red-600 hover:bg-red-700 transition-all"
                    >
        ...
        {filteredProducts.length > 0 && (
          <div className="mt-12 bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              <div className="flex-1">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Resumen del Catálogo - Caducados</h3>

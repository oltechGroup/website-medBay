...
import { ArrowLeft, Package, Search, Filter, Download, DollarSign, Box, BarChart3 } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center space-x-4 mb-4 sm:mb-0">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">Catálogo - Lotes en Fecha</h1>
                <p className="text-gray-600">
                  Lotes con fecha de caducidad vigente del proveedor
                </p>
              </div>
            </div>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">Lotes en fecha</p>
              </div>
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div className="flex space-x-4">
              <select
                ...
                className="border border-gray-300 rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all"
              >
          ...
          <>
            {filteredProducts.length > 0 ? (
              ...
              <div className="text-center py-16 bg-white border border-gray-200 rounded-lg hover:shadow-md transition-shadow">
                <div className="p-4 bg-green-50 rounded-full w-24 h-24 mx-auto mb-6 flex items-center justify-center">
                  <Package className="h-12 w-12 text-green-600" />
                </div>
                <h3 className="text-2xl font-bold text-gray-900 mb-3">
                  {searchTerm ? 'No se encontraron lotes' : 'No hay lotes en fecha'}
                </h3>
                <p className="text-gray-600 max-w-md mx-auto mb-8 leading-relaxed">
                  {searchTerm 
                    ? 'No se encontraron lotes que coincidan con tu búsqueda. Intenta con otros términos.'
                    : 'Los lotes con fecha vigente aparecerán aquí una vez que sean importados desde el módulo de importación.'
                  }
                </p>
                <div className="flex justify-center space-x-4">
                  {searchTerm && (
                    <button
                      onClick={() => setSearchTerm('')}
                      className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-green-600 hover:bg-green-700 transition-all"
                    >
        ...
        {filteredProducts.length > 0 && (
          <div className="mt-12 bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Resumen del Catálogo</h3>

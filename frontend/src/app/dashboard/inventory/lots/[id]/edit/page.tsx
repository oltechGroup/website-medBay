      ...
      <div className="min-h-screen bg-gray-50 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center py-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Lot not found</h2>
            <p className="text-gray-600 mb-8">The lot you are trying to edit does not exist.</p>
            <button
              onClick={() => router.push('/dashboard/inventory/lots')}
              className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700"
            >
              Back to lot management
            </button>
          </div>
        </div>
      </div>

...
export default function AssignCategoriesPage() {
  ...
  return (
    <div className="space-y-6">
      {/* 🎯 Encabezado Mejorado y Simplificado */}
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div className="flex-1">
          <h1 className="text-2xl font-bold text-gray-900">🏷️ Asignar Categorías</h1>
          <p className="mt-1 text-sm text-gray-600">
            Sistema simplificado para asignar categorías a productos de forma masiva
          </p>
        </div>

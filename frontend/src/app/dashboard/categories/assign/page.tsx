...
export default function AssignProductsPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header with buttons as requested */}
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Assign Products to Categories</h1>
          <p className="text-sm text-gray-600 mt-1">
            Bulk system to link products with categories
          </p>
        </div>
      ...
      {isLoading ? (
        <div className="min-h-96 flex justify-center items-center">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-600">Loading categories and products...</p>
          </div>
        </div>
      ) : (

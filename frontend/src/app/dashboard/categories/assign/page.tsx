...
import { CategoryProductAssign } from '@/components/features/categories/CategoryProductAssign';
...
export default function AssignProductsPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header con botones como los pediste */}
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Asignar Productos a Categorías</h1>
          <p className="text-sm text-gray-600 mt-1">
            Sistema masivo para relacionar productos con categorías
          </p>
        </div>
        
        {/* Botones EXACTAMENTE como los pediste */}
      ...
      {isLoading ? (
        <div className="min-h-96 flex justify-center items-center">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-600">Cargando categorías y productos...</p>
          </div>
        </div>
      ) : (
        <CategoryProductAssign

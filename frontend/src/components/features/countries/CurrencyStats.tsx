...
// Función helper para convertir exchange_rate de forma segura
...
export function CurrencyStats({ countries }: CurrencyStatsProps) {
  // CORRECCIÓN: Usar la función segura para todos los cálculos
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
        ...
        Resumen de Tasas de Cambio vs USD
      </h3>
      
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <p className="text-sm font-medium text-blue-800">Tasa Más Alta</p>
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
          <p className="text-sm font-medium text-green-800">Tasa Promedio</p>
          <p className="text-2xl font-bold text-green-900">{averageRate.toFixed(4)}</p>
          <p className="text-xs text-green-600 mt-1">Promedio de {countries.length} países</p>
        </div>
        
        <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
          <p className="text-sm font-medium text-orange-800">Tasa Más Baja</p>
      ...
      {/* Tabla simplificada de tasas */}
      <div className="mt-6">
        <h4 className="text-sm font-medium text-gray-700 mb-3">Tasas por País</h4>

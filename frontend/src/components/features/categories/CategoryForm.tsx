...
export const CategoryForm = ({ category, onSuccess }: CategoryFormProps) => {
  ...
  // Filtrar categorías para evitar bucles infinitos (no permitir seleccionarse a sí misma o sus hijos)
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="Ej: Medicamentos, Equipamiento Médico..."
                disabled={loading}
              />
              {errors.name && (
              ...
              >
                ...
                {availableParentCategories.map((cat) => (
                  <option key={cat.id} value={cat.id}>
                    {cat.name} {cat.parent_name && `(Subcategoría de ${cat.parent_name})`}
                  </option>
                ))}
              </select>
